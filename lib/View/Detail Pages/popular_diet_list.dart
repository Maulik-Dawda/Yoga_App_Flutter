...
class PopularDietList extends StatelessWidget {
  const PopularDietList({super.key});

  @override
  Widget build(BuildContext context) {
    final PopularDietController controller = Get.put(PopularDietController());
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (controller.popularDietList.isEmpty) {
          return const Center(
        ...
        return Padding(
          ...
          child: GridView.builder(
            itemCount: controller.popularDietList.length,
            ...
            itemBuilder: (context, index) {
              final item = controller.popularDietList[index];
