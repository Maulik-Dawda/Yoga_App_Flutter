...
class YouMustTryDietList extends StatelessWidget {
  const YouMustTryDietList({super.key});

  @override
  Widget build(BuildContext context) {
    final YouMustTryDietController controller = Get.put(YouMustTryDietController());
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (controller.youMustTryDietList.isEmpty) {
          return const Center(
        ...
        return Padding(
          ...
          child: GridView.builder(
            itemCount: controller.youMustTryDietList.length,
            ...
            itemBuilder: (context, index) {
              final item = controller.youMustTryDietList[index];
